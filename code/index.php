...
<main>
    <div class="top-bar">
        <div class="friend-username">
            ...
            <p class="gg-semibold">Nom d'affichage</p>
        </div>
        <div class="friend-options">
            <svg xmlns="http://www.w3.org/2000/svg" x="0" y="0" class="icon__9293f" aria-hidden="true" role="img" width="18" height="18" fill="none" viewBox="0 0 24 24" color="#94959C"><path fill="currentColor" d="M2 7.4A5.4 5.4 0 0 1 7.4 2c.36 0 .7.22.83.55l1.93 4.64a1 1 0 0 1-.43 1.25L7 10a8.52 8.52 0 0 0 7 7l1.12-2.24a1 1 0 0 1 1.19-.51l5.06 1.56c.38.11.63.46.63.85C22 19.6 19.6 22 16.66 22h-.37C8.39 22 2 15.6 2 7.71V7.4ZM13 3a1 1 0 0 1 1-1 8 8 0 0 1 8 8 1 1 0 1 1-2 0 6 6 0 0 0-6-6 1 1 0 0 1-1-1Z" class=""/><path fill="currentColor" d="M13 7a1 1 0 0 1 1-1 4 4 0 0 1 4 4 1 1 0 1 1-2 0 2 2 0 0 0-2-2 1 1 0 0 1-1-1Z" class=""/></svg>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" x="0" y="0" class="icon__9293f" aria-hidden="true" role="img" width="18" height="18" fill="none" viewBox="0 0 24 24" color="#94959C"><path fill="currentColor" d="M19.38 11.38a3 3 0 0 0 4.24 0l.03-.03a.5.5 0 0 0 0-.7L13.35.35a.5.5 0 0 0-.7 0l-.03.03a3 3 0 0 0 0 4.24L13 5l-2.92 2.92-3.65-.34a2 2 0 0 0-1.6.58l-.62.63a1 1 0 0 0 0 1.42l9.58 9.58a1 1 0 0 0 1.42 0l.63-.63a2 2 0 0 0 .58-1.6l-.34-3.64L19 11l.38.38ZM9.07 17.07a.5.5 0 0 1-.08.77l-5.15 3.43a.5.5 0 0 1-.63-.06l-.42-.42a.5.5 0 0 1-.06-.63L6.16 15a.5.5 0 0 1 .77-.08l2.14 2.14Z" class=""/></svg>
            <svg xmlns="http://www.w3.org/2000/svg" x="0" y="0" class="icon__9293f" aria-hidden="true" role="img" width="18" height="18" fill="none" viewBox="0 0 24 24" color="#94959C"><path fill="currentColor" d="M14.5 8a3 3 0 1 0-2.7-4.3c-.2.4.06.86.44 1.12a5 5 0 0 1 2.14 3.08c.01.06.06.1.12.1ZM16.62 13.17c-.22.29-.65.37-.92.14-.34-.3-.7-.57-1.09-.82-.52-.33-.7-1.05-.47-1.63.11-.27.2-.57.26-.87.11-.54.55-1 1.1-.92 1.6.2 3.04.92 4.15 1.98.3.27-.25.95-.65.95a3 3 0 0 0-2.38 1.17ZM15.19 15.61c.13.16.02.39-.19.39a3 3 0 0 0-1.52 5.59c.2.12.26.41.02.41h-8a.5.5 0 0 1-.5-.5v-2.1c0-.25-.31-.33-.42-.1-.32.67-.67 1.58-.88 2.54a.2.2 0 0 1-.2.16A1.5 1.5 0 0 1 2 20.5a7.5 7.5 0 0 1 13.19-4.89ZM9.5 12a3 3 0 1 0 0-6 3 3 0 0 0 0 6ZM15.5 22Z" class=""/><path fill="currentColor" d="M19 14a1 1 0 0 1 1 1v3h3a1 1 0 0 1 0 2h-3v3a1 1 0 0 1-2 0v-3h-3a1 1 0 1 1 0-2h3v-3a1 1 0 0 1 1-1Z" class=""/></svg>
            <svg xmlns="http://www.w3.org/2000/svg" x="0" y="0" class="icon__9293f" aria-hidden="true" role="img" width="18" height="18" fill="none" viewBox="0 0 24 24" color="#94959C"><path fill="currentColor" fill-rule="evenodd" d="M23 12.38c-.02.38-.45.58-.78.4a6.97 6.97 0 0 0-6.27-.08.54.54 0 0 1-.44 0 8.97 8.97 0 0 0-11.16 3.55c-.1.15-.1.35 0 .5.37.58.8 1.13 1.28 1.61.24.24.64.15.8-.15.19-.38.39-.73.58-1.02.14-.21.43-.1.4.15l-.19 1.96c-.02.19.07.37.23.47A8.96 8.96 0 0 0 12 21a.4.4 0 0 1 .38.27c.1.33.25.65.4.95.18.34-.02.76-.4.77L12 23a11 11 0 1 1 11-10.62ZM15.5 7.5a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0Z" clip-rule="evenodd" class=""/><path fill="currentColor" d="M24 19a5 5 0 1 1-10 0 5 5 0 0 1 10 0Z" class=""/></svg>
    ...
    <div class="message-fill">
        ...
        <div class="send-message">
            <img src="#" alt="Choisir une pièce jointe" class="add-file">
    ...
    <div class="friend-informations">
        <div class="friend-banner">
            <img class="banner" src="#" alt="friend's banner">
            <img class="friend-avatar" src="#" alt="friend's avatar">
        </div>
        <div class="friend-usernames">
            <p class="friend-display-name gg-semibold">Nom d'affichage</p>
            <p class="discord-id">Discord ID</p>
        </div>
        <div class="friend-member-since">
            <div class="member-since">
                <p class="gg-semibold">Membre depuis</p>
                <p class="date-member gg-regular">Date de création du compte</p>
            </div>
        </div>
        <div class="friend-common">
            <p class="common-servers gg-semibold">Serveurs en commun -- 1</p>
            <p class="common-friends gg-semibold">Amis en commun -- 1</p>
        </div>
        <div class="friend-profile-options">
