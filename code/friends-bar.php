<div class="friends-bar">
    ...
    <div class="options">
        <div class="amis">
            ...
            <a class="gg-semibold" href="/Discord/code/main.php?">Amis</a>
        </div>
        <div class="nitro">
    ...
    <div class="friends">
        <a href="/Discord/code/main.php?page=mp" class="friend friend-1">
        ...
        <a href="/Discord/code/main.php?page=mp" class="friend friend-3">
        ...
        <a href="/Discord/code/main.php?page=mp" class="friend friend-4">
